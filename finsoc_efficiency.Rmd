...
```{r, fig.width = 12, fig.height=8, fig.cap = "Financial versus Social Efficiency of MFIs in Africa"}
my_data %>% 
...
explaining the determinants of financial and social efficiency [@assaf2010improving]. The bootstrapped DEA scores serve as the dependent variables in the regression analysis. This section provides results from the regression models on the drivers of socio-financial efficiency of MFIs in Africa.
